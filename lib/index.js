...
exports.runCommand = function(cmd, callback) {
    ...
    console.log(internals.Smelt.settings.dirPath);
    var subProcess = Child.spawn.apply(Child.spawn, [ command.cmd, command.args ], { cwd: internals.Smelt.settings.dirPath });
